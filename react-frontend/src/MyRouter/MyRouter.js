...
import SingleAttendancePage from "../components/AttendancePage/SingleAttendancePage";
// ~cb-add-import~
        ...
        <Routes>
            ...
            <Route element={<ProtectedRoute redirectPath={'/login'} />}>
                <Route path="/account" exact element={<Account />} />
                    ...
                    <Route path="/attendance/:singleAttendanceId" exact element={<SingleAttendancePage />} />
